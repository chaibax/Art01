            ...
            <div className="imageblink ">
                <div className="has-text-centered">
                    ...
                    <a href={link} download="Art01.png" target="_blank">
                        <img src={pixeladded_image} className="bottom" style={{ imageRendering: 'pixelated', backgroundColor: 'rgba(255, 255, 255, 1)', height: '80vmin', width: '80vim', zIndex: 1 }} />
                    </a>
                    <a href={link} download="Art01.png" target="_blank">
                        <img src={link} className="imagetop" style={{ imageRendering: 'pixelated', backgroundColor: 'rgba(255, 255, 255, 1)', height: '80vmin', width: '80vim', zIndex: 1 }} />
                    </a>
